...
/**
 * Copied from https://github.com/pact-foundation/pact-jvm/blob/e297ef75761f5008aac4b63550d1871f33119aab/consumer/junit/src/test/java/au/com/dius/pact/consumer/junit/exampleclients/ConsumerClient.java
 */
public class ConsumerClient {
  ...
  public Map get(String path) throws IOException {
    ...
    return jsonToMap(response.getType() != null ? response.asString()
        : response.asString(Charset.defaultCharset()));
  }
