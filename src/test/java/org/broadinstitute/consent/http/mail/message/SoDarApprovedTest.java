...
class SoDarApprovedTest {
  ...
  void testGetSoDarApprovedTemplate() throws Exception {
    ...
    assertTrue(templateString.contains(datasets.get(0).getDatasetIdentifier()));
    assertTrue(templateString.contains(datasets.get(0).getName()));
  }
}
