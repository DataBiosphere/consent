...
public class ReminderMessageTest {
    ...
    public void testMessageSubject() throws MessagingException {
        ...
        Assertions.assertEquals("Urgent: Log vote on Data Use Limitations case id: DUL-123.",
            message.getSubject());
        Mail message2 = new ReminderMessage().reminderMessage("to@address.com", "from@address.com", template, "DAR-123", "Data Access Request");
        Assertions.assertEquals("Urgent: Log votes on Data Access Request case id: DAR-123.",
            message2.getSubject());
        Mail message3 = new ReminderMessage().reminderMessage("to@address.com", "from@address.com", template, "RP-123", "Research Purpose");
        Assertions.assertEquals("Urgent: Log votes on Research Purpose Review case id: RP-123.",
            message3.getSubject());
    }
