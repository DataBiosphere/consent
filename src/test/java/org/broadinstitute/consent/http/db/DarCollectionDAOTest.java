...
public class DarCollectionDAOTest extends DAOTestHelper {
    ...
    public void testFindAllDARCollections() {
        ...
        Assertions.assertTrue(allAfter.contains(collection));
        ...
        Assertions.assertTrue(elections.size() > 0);
    ...
    public void testFindDARCollectionByReferenceId() {
        ...
        Assertions.assertTrue(ids.contains(dar.getReferenceId()));
    }
    ...
    public void testFindDARCollectionsByReferenceIds() {
        ...
        Assertions.assertTrue(darCollectionIds.contains(dar1.collectionId));
        Assertions.assertTrue(darCollectionIds.contains(dar2.collectionId));
    ...
    public void testFindDARCollectionByCollectionId() {
        ...
        List<Election> datasetElections = getDatasetElectionsFromElection(elections);
        Assertions.assertTrue(datasetElections.isEmpty());
        ...
        Assertions.assertEquals("Open", election.getStatus());
    ...
    public void testFindDARCollectionByCollectionIdLibraryCard() {
        ...
        Assertions.assertEquals(1, returnedLibraryCards.size());
        Assertions.assertEquals(libraryCard, returnedLibraryCards.get(0));
        Assertions.assertEquals(user.getUserId(), returnedLibraryCards.get(0).getUserId());
    }
    ...
    public void testInsertDARCollection() {
        ...
        Assertions.assertTrue(allBefore.isEmpty());
    ...
    public void testUpdateDARCollection() {
        ...
        Assertions.assertEquals(user.getUserId(), updated.getUpdateUserId());
        Assertions.assertEquals(date, updated.getUpdateDate());
    }
    ...
    public void testGetFilteredListForResearcher_SortField() {
        ...
        Assertions.assertEquals(2, collectionsResult.size());
        ...
        Assertions.assertTrue(comparatorValue < 0);
    }
    ...
    public void testGetFilteredListForResearcher_ProjectTitleTerm() {
        ...
        Assertions.assertEquals(1, collections.size());
        DarCollection targetCollection = collections.get(0);
        Assertions.assertEquals(1, targetCollection.getDars().size());
        Assertions.assertEquals(darCode, targetCollection.getDarCode());
    }
    ...
    public void testGetFilteredListForResearcher_sortDirectionTerm_DESC() {
        ...
        Assertions.assertEquals(2, collectionsResult.size());
        Assertions.assertEquals(collections.get(0).getDarCode(),
            collectionsResult.get(0).getDarCode());
        Assertions.assertEquals(collections.get(1).getDarCode(),
            collectionsResult.get(1).getDarCode());
        Assertions.assertEquals(1, collectionsResult.get(0).getDars().size());
        Assertions.assertEquals(1, collectionsResult.get(1).getDars().size());
    }
    ...
    public void testFindAllDARCollectionsCreatedByUserId() {
        ...
        Assertions.assertEquals(userId, collectionResult.get(0).getCreateUserId());
        ...
        Assertions.assertEquals(1, electionList.size());
        List<String> referenceIds = collectionRecord.getDars().values().stream()
                .map(DataAccessRequest::getReferenceId)
                .collect(Collectors.toList());

        Assertions.assertTrue(referenceIds.contains(electionList.get(0).getReferenceId()));
    ...
    public void testGetFilteredListForSigningOfficialOnDarCode() {
        ...
        Assertions.assertEquals(0, negativeTestCollection.size());
    }
    ...
    public void testGetFilteredListForSigningOfficialOnProjectTitle() {
        DarCollection collection = createDarCollection();
        User user = userDAO.findUserById((collection.getCreateUserId()));
        Assertions.assertTrue(collection.getDars().values().stream().findAny().isPresent());
    ...
    public void testGetFilteredListForDacByCollectionIdsOnDarCode() {
        ...
        Assertions.assertEquals(0, negativeTest.size());
    }
    ...
    public void testGetFilteredListForDacByCollectionIdsOnProjectTitle() {
        ...
        Assertions.assertTrue(collection.getDars().values().stream().findAny().isPresent());
        DataAccessRequest targetDar = collection.getDars().values().stream().findAny().get();
        Assertions.assertTrue(negativeCollection.getDars().values().stream().findAny().isPresent());
    ...
    public void testGetFilteredListForAdminOnDarCode() {
        ...
        Assertions.assertEquals(1, collections.size());
        Assertions.assertEquals(0, negativeCollections.size());
        List<DarCollection> emptyTermCollections = darCollectionDAO.getFilteredCollectionsForAdmin("dar_code", "DESC", "");
        Assertions.assertEquals(2, emptyTermCollections.size());
    }
    ...
    public void testFindDARCollectionIdsByDacIdsArchived() {
        ...
        Assertions.assertTrue(collectionIds.isEmpty());
    ...
    public void testFindDARCollectionIdsByCollectionIdsArchived() {
        ...
        Assertions.assertTrue(returnedCollections.contains(testDarCollection2));
    }
    ...
    public void testFindDARCollectionByReferenceIdArchived() {
        ...
        Assertions.assertTrue(validCollection.equals(testDarCollection2));
    }
    ...
    public void testGetFilteredCollectionsForDACByCollectionIdsArchived() {
        ...
        Assertions.assertTrue(collections.contains(testDarCollection2));
    }
}