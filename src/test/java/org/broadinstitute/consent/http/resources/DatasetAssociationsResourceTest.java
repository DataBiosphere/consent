...
public class DatasetAssociationsResourceTest {
  ...
  public void testAssociateDatasetWithUsers() {
    initResource();
    Response response = resource.associateDatasetWithUsers(RandomUtils.nextInt(1, 100),
  ...
  public void testUpdateDatasetAssociations() {
    initResource();
    Response response = resource.updateDatasetAssociations(RandomUtils.nextInt(1, 100),
        Collections.emptyList());
    assertEquals(HttpStatusCodes.STATUS_CODE_OK, response.getStatus());
  }
