...
public class ConsentCasesResourceTest {
  ...
  public void testGetConsentSummaryDetailFileDUL() {
    ...
    initResource();
    Response response = resource.getConsentSummaryDetailFile(ElectionType.TRANSLATE_DUL.getValue(),
        null);
    assertEquals(200, response.getStatus());
  ...
  public void testGetConsentSummaryDetailFileDataAccess() {
    ...
    initResource();
    Response response = resource.getConsentSummaryDetailFile(ElectionType.DATA_ACCESS.getValue(),
        null);
    assertEquals(200, response.getStatus());
    Object summaryDetails = response.getEntity();
    assertNull(summaryDetails);
