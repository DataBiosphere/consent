...
public class DatabaseDataSetAssociationAPITest {
    ...
    public void setUp(){
        ...
        associationAPI = new DatabaseDataSetAssociationAPI(dsDAO, dsAssociationDAO, userDAO);
    }
    ...
    User chairperson = new User(1, "originalchair@broad.com", "Original Chairperson", RoleStatus.PENDING.toString(), new Date(), chairpersonList(), null);
    User member = new User(2, "originalchair@broad.com", "Original Chairperson", RoleStatus.PENDING.toString(), new Date(), memberList(), null);
    User dataOwner1 = new User(3, "originalchair@broad.com", "Original Chairperson", RoleStatus.PENDING.toString(), new Date(), dataownerList(), null);
    User dataOwner2 = new User(4, "originalchair@broad.com", "Original Chairperson", RoleStatus.PENDING.toString(), new Date(), dataownerList(), null);
