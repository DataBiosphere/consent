...
public class GenericUser {
  ...
  /**
   * Convenience method to deserialize from Google's userinfo API, e.g.: { "sub": "...", "name":
   * "Gregory Rushton", "given_name": "Gregory", "family_name": "Rushton", "profile":
   * "https://plus.google.com/...", "picture": "https://lh3.googleusercontent.com/...", "email":
   * "grushton@broadinstitute.org", "email_verified": true, "locale": "en", "hd":
   * "broadinstitute.org" }
   *
