...
public class AuditPageResults {
  ...
  private final Integer totalRecords; // total number of records that would have been satisfied by the query without pagination.
  private final Integer pageSize; // number of entries on this page
  private final Integer page; // page number

  public AuditPageResults(List<DACAutomationRuleAudit> auditRecords, Integer totalRecords, Integer pageSize, Integer page) {
