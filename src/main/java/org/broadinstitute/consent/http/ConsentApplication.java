...
public class ConsentApplication extends Application<ConsentConfiguration> {
    ...
    public void run(ConsentConfiguration config, Environment env) {
        ...
        DatabaseDataAccessRequestAPI.initInstance(dataAccessRequestService, useRestrictionConverter, electionDAO, consentDAO, voteDAO, userDAO, dataSetDAO,
            userPropertyDAO);
        DatabaseMatchAPI.initInstance(matchDAO, consentDAO);
        DatabaseMatchingServiceAPI.initInstance(client, dataAccessRequestDAO, config.getServicesConfiguration(), consentService, datasetService, useRestrictionConverter);
        ...
        env.jersey().register(new DataAccessRequestResource(dataAccessRequestService, emailNotifierService, userService, consentService));
        ...
        env.jersey().register(new ConsentResource(auditService, userService, consentService));
        ...
        env.jersey().register(new ElectionReviewResource(dataAccessRequestService, consentService));
