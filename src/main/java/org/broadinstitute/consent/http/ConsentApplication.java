...
public class ConsentApplication extends Application<ConsentConfiguration> {
    ...
    public void run(ConsentConfiguration config, Environment env) {
        ...
        env.jersey().register(new ConsentElectionResource(consentService, dacService, emailService, voteService, electionService));
        ...
        env.jersey().register(new DataRequestVoteResource(dataAccessRequestService, darCollectionService, datasetAssociationService, emailService, voteService, datasetService, electionService, userService));
