...
public interface CloudStore {
  ...
  String putStorageDocument(InputStream stream, String type, String fileName)
      throws IOException, GeneralSecurityException;

  String postStorageDocument(InputStream stream, String type, String fileName)
      throws IOException, GeneralSecurityException;

  GenericUrl generateURLForDocument(String fileName);

  String postOntologyDocument(InputStream stream, String type, String fileName)
