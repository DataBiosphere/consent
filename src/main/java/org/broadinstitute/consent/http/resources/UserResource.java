...
public class UserResource extends Resource {
    ...
    public Response getUser(@Auth AuthUser authUser) {
        try {
            ...
            JsonObject userJson = userService.constructUserJsonObjectWithProperties(authUser, user.getDacUserId());
    ...
    public Response getUserById(@Auth AuthUser authUser, @PathParam("userId") Integer userId) {
        try {
            JsonObject userJson = userService.constructUserJsonObjectWithProperties(authUser, userId);
            return Response.ok(gson.toJson(userJson)).build();
        } catch (Exception e) {
            return createExceptionResponse(e);
        }
