...
public interface DatasetDAO extends Transactional<DatasetDAO> {
    ...
    @SqlQuery(" SELECT d.*, k.key, dp.propertyvalue, dp.propertykey, dp.propertyid, ca.consentid, c.dac_id, c.translateduserestriction, c.datause, dd.dataset_id as in_use " +
        " FROM dataset d " +
        " LEFT JOIN dar_dataset dd ON dd.dataset_id = d.datasetid" +
