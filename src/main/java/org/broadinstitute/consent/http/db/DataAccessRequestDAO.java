...
public interface DataAccessRequestDAO extends Transactional<DataAccessRequestDAO> {
    ...
    @SqlUpdate("update data_access_request set data = :data where reference_id = :referenceId")
    void updateDataByReferenceId(@Bind("referenceId") String referenceId, @Json DataAccessRequestData darData);
    ...
    @SqlUpdate("insert into data_access_request (reference_id, data) values (:referenceId, :data) ")
    void insert(@Bind("referenceId") String referenceId, @Json DataAccessRequestData data);
