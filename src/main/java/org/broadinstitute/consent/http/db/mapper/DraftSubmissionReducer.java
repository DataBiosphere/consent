...
public class DraftSubmissionReducer implements LinkedHashMapRowReducer<UUID, DraftSubmissionInterface>, RowMapperHelper{
    ...
    public void accumulate(Map<UUID, DraftSubmissionInterface> map, RowView rowView) {
        ...
        if (hasNonZeroColumn(rowView, "fso_fileStorage_object_id")) {
