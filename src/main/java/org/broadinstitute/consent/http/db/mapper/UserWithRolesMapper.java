...
/**
 * This class works well for collections. When a query returns a single user, all rows are not
 * iterated over regardless of the number of records returned by the query. See @UserReducer for
 * mapping results on a single user.
 */
