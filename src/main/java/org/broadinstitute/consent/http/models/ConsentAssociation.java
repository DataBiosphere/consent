...
/**
 * ConsentAssociation Representation object. Represents a set of consentassociations to a single
 * "type" of object.  For example, the "sampleSet"s associated with an individual consent via the
 * dataset id on consentassociations. See also: Association
 */
