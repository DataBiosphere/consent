...
public class PaginationToken {
  ...
  public PaginationToken(Integer page, Integer pageSize, String sortField, String sortDirection,
      String filterTerm, Map<String, String> acceptableSortFields, String defaultField) {
    this.acceptableSortFields = acceptableSortFields;
    this.page = page;
    this.pageSize = Objects.nonNull(pageSize) ? pageSize : 10;
    this.sortField = Objects.isNull(sortField) ? acceptableSortFields.get(defaultField)
        : validateSortField(sortField);
    this.sortDirection =
        Objects.isNull(sortDirection) ? "DESC" : validateSortDirection(sortDirection);
  ...
  public PaginationToken(Integer page, Integer pageSize, String sortField, String sortDirection,
      ...
      Map<String, String> acceptableSortFields) {
    this.acceptableSortFields = acceptableSortFields;
    this.page = page;
