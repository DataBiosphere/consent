...
public class DataSet {
    ...
    public DataSet(Integer dataSetId, String objectId, String name, Date createDate, Boolean active, Integer alias, Integer createUserId, Date updateDate, Integer updateUserId) {
