...
public class ConsentGroup {
  ...
  public String toString() {
    ...
    sb.append(ConsentGroup.class.getName())
        .append('@')
  ...
  public int hashCode() {
    ...
    result =
        ((result * 31)
            + ((this.generalResearchUse == null) ? 0 : this.generalResearchUse.hashCode()));
    result = ((result * 31) + ((this.poa == null) ? 0 : this.poa.hashCode()));
    result = ((result * 31) + ((this.morDate == null) ? 0 : this.morDate.hashCode()));
    result =
        ((result * 31)
            + ((this.dataAccessCommitteeId == null) ? 0 : this.dataAccessCommitteeId.hashCode()));
    ...
    result =
        ((result * 31)
            + ((this.numberOfParticipants == null) ? 0 : this.numberOfParticipants.hashCode()));
    result = ((result * 31) + ((this.fileTypes == null) ? 0 : this.fileTypes.hashCode()));
    result =
        ((result * 31)
            + ((this.diseaseSpecificUse == null) ? 0 : this.diseaseSpecificUse.hashCode()));
    result = ((result * 31) + ((this.datasetId == null) ? 0 : this.datasetId.hashCode()));
    result =
        ((result * 31)
            + ((this.datasetIdentifier == null) ? 0 : this.datasetIdentifier.hashCode()));
    result =
        ((result * 31) + ((this.consentGroupName == null) ? 0 : this.consentGroupName.hashCode()));
    ...
    result =
        ((result * 31) + ((this.accessManagement == null) ? 0 : this.accessManagement.hashCode()));
  ...
  public boolean equals(Object other) {
    ...
    return ((((((((((((((((((((((this.col == rhs.col)
                                                                        ...
                                                                        && ((this.morDate
                                                                            ...
                                                                            || ((this.morDate
                                                                                ...
                                                                                && this.morDate
                                                                                    .equals(
                                                                                        rhs.morDate))))
                                                                    && ((this.dataAccessCommitteeId
                                                                            == rhs.dataAccessCommitteeId)
                                                                        || ((this
                                                                                    .dataAccessCommitteeId
                                                                                != null)
                                                                            && this
                                                                ...
                                                                && ((this.otherPrimary
                                                                        == rhs.otherPrimary)
                                                                    || ((this.otherPrimary != null)
                                                                        && this.otherPrimary.equals(
                                                                            rhs.otherPrimary))))
                                                            && ((this.gs == rhs.gs)
                                                                || ((this.gs != null)
                                                                    && this.gs.equals(rhs.gs))))
                                                        && ((this.url == rhs.url)
                                                            || ((this.url != null)
                                                                && this.url.equals(rhs.url))))
                                                    && ((this.fileTypes == rhs.fileTypes)
                                                        || ((this.fileTypes != null)
                                                            && this.fileTypes.equals(
                                                                rhs.fileTypes))))
                                                && ((this.diseaseSpecificUse
                                                        == rhs.diseaseSpecificUse)
                                                    || ((this.diseaseSpecificUse != null)
                                                        && this.diseaseSpecificUse.equals(
                                                            rhs.diseaseSpecificUse))))
                                            && ((this.datasetId == rhs.datasetId)
                                                || ((this.datasetId != null)
                                                    && this.datasetId.equals(rhs.datasetId)))
                                            && ((this.datasetIdentifier == rhs.datasetIdentifier)
                                                || ((this.datasetIdentifier != null)
                                                    && this.datasetIdentifier.equals(
                                                        rhs.datasetIdentifier)))
                                            && ((this.consentGroupName == rhs.consentGroupName)
                                                || ((this.consentGroupName != null)
                                                    && this.consentGroupName.equals(
                                                        rhs.consentGroupName))))
                                        && ((this.mor == rhs.mor)
                                            || ((this.mor != null) && this.mor.equals(rhs.mor))))
                                    && ((this.npu == rhs.npu)
                                        || ((this.npu != null) && this.npu.equals(rhs.npu))))
                                && ((this.dataLocation == rhs.dataLocation)
                                    || ((this.dataLocation != null)
                                        && this.dataLocation.equals(rhs.dataLocation))))
                            && ((this.accessManagement == rhs.accessManagement)
                                || ((this.accessManagement != null)
                                    && this.accessManagement.equals(rhs.accessManagement))))
                        && ((this.irb == rhs.irb)
                            || ((this.irb != null) && this.irb.equals(rhs.irb))))
  ...
  public enum AccessManagement {
    ...
    EXTERNAL("external");
    private final String value;
    private static final Map<String, ConsentGroup.AccessManagement> CONSTANTS =
        new HashMap<String, ConsentGroup.AccessManagement>();
