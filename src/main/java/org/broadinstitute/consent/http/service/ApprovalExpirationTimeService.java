...
public class ApprovalExpirationTimeService {
  ...
  @Inject
  public ApprovalExpirationTimeService(
      ApprovalExpirationTimeDAO approvalExpirationTimeDAO, UserDAO userDAO) {
  ...
  public ApprovalExpirationTime create(ApprovalExpirationTime approvalExpirationTime) {
    ...
    Integer id =
        approvalExpirationTimeDAO.insertApprovalExpirationTime(
            new Date(),
            approvalExpirationTime.getAmountOfDays(),
            approvalExpirationTime.getUserId());
    return findApprovalExpirationTimeById(id);
  }

  public ApprovalExpirationTime update(ApprovalExpirationTime approvalExpirationTime, Integer id)
      throws NotFoundException {
    validateRequiredFields(approvalExpirationTime);
    approvalExpirationTimeDAO.updateApprovalExpirationTime(
        id,
        approvalExpirationTime.getAmountOfDays(),
        new Date(),
        approvalExpirationTime.getUserId());
  ...
  public ApprovalExpirationTime findApprovalExpirationTimeById(Integer id)
      throws NotFoundException {
    ApprovalExpirationTime approvalExpirationTime =
        approvalExpirationTimeDAO.findApprovalExpirationTimeById(id);
    if (approvalExpirationTime == null) {
