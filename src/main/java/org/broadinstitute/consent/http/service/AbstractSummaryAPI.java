 ...
 * object management.
 */
public abstract class AbstractSummaryAPI implements SummaryAPI {
     ...
     * to call setInstance().
     */
    protected static class SummaryAPIHolder {
        private static SummaryAPI theInstance = null;
         ...
         */
        public static void setInstance(SummaryAPI api) {
            if (theInstance != null)
         ...
         */
        public static SummaryAPI getInstance() {
            if (theInstance == null)
                throw new IllegalStateException();
            return theInstance;
        }
     ...
     */
    public static SummaryAPI getInstance() {
        return SummaryAPIHolder.getInstance();
    }
