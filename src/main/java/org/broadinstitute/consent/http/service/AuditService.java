...
public class AuditService {
  ...
  public void saveAssociationAuditList(List<String> ids, String modifiedTable, String changeAction,
      String modifiedByUserEmail) {
    int modifiedByUserId = userDAO.findUserByEmail(modifiedByUserEmail).getUserId();
    List<ConsentAudit> auditList = createAuditList(ids, modifiedTable, changeAction,
        modifiedByUserId);
    consentAuditDAO.batchInsertWorkspaceAudit(auditList);
  }

  private List<ConsentAudit> createAuditList(List<String> ids, String modifiedTable,
      String changeAction, int modifiedByUserId) {
  ...
  public void saveConsentAudit(String consentId, String modifiedTable, String changeAction,
      String modifiedByUserEmail) {
    int modifiedByUserId = userDAO.findUserByEmail(modifiedByUserEmail).getUserId();
    saveAuditInfo(
        new ConsentAudit(consentId, modifiedTable, changeAction, modifiedByUserId, new Date()));
  }
