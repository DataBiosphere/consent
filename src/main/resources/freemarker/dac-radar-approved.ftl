...
<head>
  ...
  <title>Broad Data Use Oversight System - Data Access Committee - Access to a dataset was Rule Automated DAR (RADAR) approved</title>
</head>
    ...
    <table style="width: 600px">
      ...
      <tr>
        <td style="padding: 15px 15px 0px; text-align: center;">
          <img src="https://duos.org/images/favicon/android-chrome-192x192.png" height="100px" width="100px"
            alt="DUOS Logo">
        </td>
      </tr>
      <tr>
        <td id="userName"
          style="padding: 15px 15px 0px; font-family: 'Montserrat', sans-serif; font-size: 22px; color: #1F3B50; text-align: left; line-height: 25px; display: block; font-weight: 500;">
          Hello ${userName},
        </td>
      </tr>
      <tr>
