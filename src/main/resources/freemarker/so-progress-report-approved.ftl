...
<#include "/freemarker/header.ftl">
      ...
      <tr>
        <td
          ...
          <p style="margin-top: 20px 0 0;">Please remember that ${researcherUserName} attested to the
            following in their Data Access Request:</p>
      ...
      <tr>
        <td
          style="padding: 0px 15px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #1F3B50; text-align: left; line-height: 25px;">
          <p>You can review your institution's approved applications and attestation statement via your
            DUOS
            Signing Official Console.</p>
          <p>If approved for Broad Institute data, ${researcherUserName} should receive invitations to
            access these
            datasets within the next 24 hours (access will be designated to <a
          ...
          <p>If approved for NIH data, the PI submitting the original DAR application will be added to
            the corresponding resources in the AnVIL (anvil.terra.bio) within 24 hours and will need to
            link their AnVIL account to their eRA Commons ID (<a href="https://app.terra.bio/#profile"
