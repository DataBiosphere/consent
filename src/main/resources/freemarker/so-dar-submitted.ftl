<#assign pageTitle="Broad Data Use Oversight System - Signing Official - New Data Access Request Submitted From Your Institution">
...
<#include "/freemarker/header.ftl">
      <tr>
        <td
          ...
          A researcher from your institution, ${researcherUserName}, submitted Data Access Request
          ${darCode} for the following datasets:
        </td>
      </tr>
      <#list datasets>
        <#items as dataset>
