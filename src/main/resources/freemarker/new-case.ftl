<#assign pageTitle="Broad Data Use Oversight System - New DAR ready for your vote">
...
<#include "/freemarker/header.ftl">
        <tr>
            <td style="padding: 15px 15px 0px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #1F3B50; text-align: justify; line-height: 25px;">
                ${electionType} Review case id ${entityName}, has been created. Please click on the following link to log your vote on it:
            </td>
        </tr>
        <tr>
