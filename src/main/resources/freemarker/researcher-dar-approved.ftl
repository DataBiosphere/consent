<#assign pageTitle="Broad Data Use Oversight System - Researcher - Your access to a dataset was ${radarText}approved">
<#assign greetingHtml="Hello ${researcherName},">
<#include "/freemarker/header.ftl">
        <tr>
            <td style="padding: 0px 15px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #1F3B50; text-align: justify; line-height: 25px;">
                <p>
                    Your data access request application ${darCode} was ${radarText}approved for the following dataset(s) with the corresponding data use limitations:
                </p>
        ...
        <tr>
            <td style="padding: 0px 15px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #1F3B50; text-align: left; line-height: 25px;">
                ...
                <p style="margin-top: 20px;">Please remember you attested to the following in your data access request:</p>
                <ol style="font-size: 15px; margin: 0px;">
                    ...
                    <li>All applicable laws, local institutional policies, and terms and procedures specific to the study’s data access policy will be followed.</li>
        ...
        <tr>
            <td style="padding: 0px 15px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #1F3B50; text-align: left; line-height: 25px;">
                <p>You can review your approved applications and attestation statement via your DUOS Researcher Console.</p>
                <p>If approved for Broad Institute data, you should receive invitations to access these datasets within the next 24 hours (access will be designated to <a style="text-decoration: none; font-family: 'Montserrat', sans-serif; color: #00609F;">${researcherEmail}</a>). If you do not receive access in this time frame, please reach out to the Dataset Custodian listed on the dataset in the DUOS Dataset Catalog.</p>
                <p>If approved for NIH data, the PI submitting the original DAR application will be added to the
                    corresponding resources in the AnVIL (anvil.terra.bio) within 24 hours and will need to link their AnVIL account to their eRA Commons ID (<a href="https://app.terra.bio/#profile" style="text-decoration: none; font-family: 'Montserrat', sans-serif; color: #00609F;">here</a>)</p>
                <p>
