<#assign pageTitle="Broad Data Use Oversight System - New Progress Report submitted to your DAC">
...
<#include "/freemarker/header.ftl">
    <tr>
      <td style="padding: 15px 15px 0px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #1F3B50; text-align: justify; line-height: 25px;">
        A researcher, ${researcherUserName}, submitted Progress Report ${darID} for the following datasets:
      </td>
    </tr>
