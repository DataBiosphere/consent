...
public class ConsentAcceptanceTest extends ConsentServiceTest {
    ...
    public void testUpdateConsent() {
        ...
        Consent update = new Consent(false,  new Nothing(), null, null, UUID.randomUUID().toString(), createDate, createDate, createDate);
    ...
    public void testOnlyOrNamedConsent() {
        ...
        Consent rec = new Consent(false, new Only("http://broadinstitute.org/ontology/consent/research_on", new Or(new Named("DOID:1"), new Named("DOID:2"))),
                                  null, null, UUID.randomUUID().toString(), createDate, createDate, createDate);
        assertValidConsentResource(client, rec);
    }
    ...
    public void testAndConsent() {
        Client client = ClientBuilder.newClient();
        Consent rec = new Consent(false, new And(new Named("DOID:1"), new Named("DOID:2")), null, null, UUID.randomUUID().toString(), createDate, createDate, createDate);
        assertValidConsentResource(client, rec);
    }
    ...
    public void testNotConsent() {
        Client client = ClientBuilder.newClient();
        Consent rec = new Consent(false, new Not(new Named("DOID:1")), null, null, UUID.randomUUID().toString(), createDate, createDate, createDate);
        assertValidConsentResource(client, rec);
    }
    ...
    public void testNothingConsent() {
        Client client = ClientBuilder.newClient();
        Consent rec = new Consent(false,  new Nothing(), null, null, UUID.randomUUID().toString(), createDate, createDate, createDate);
        assertValidConsentResource(client, rec);
    }
    ...
    public void testSomeConsent() {
        ...
        Consent rec = new Consent(false,  new Some(
                ...
                new Named("DOID:1")), null, null, UUID.randomUUID().toString(), createDate, createDate, createDate);
        assertValidConsentResource(client, rec);
    }
