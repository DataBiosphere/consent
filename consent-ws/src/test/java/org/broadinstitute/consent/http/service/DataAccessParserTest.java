...
public class DataAccessParserTest {
    ...
    public void testDataAccessParserCompleted() throws IOException {
        ...
        dar.put(DarConstants.INSTITUTION, INSTITUTION);
        dar.put(DarConstants.DEPARTMENT, DEPARTMENT);
        dar.put(DarConstants.STREET_ADDRESS_1, STREET_1);
        dar.put(DarConstants.CITY, CITY);
        dar.put(DarConstants.ZIP_POSTAL_CODE, POSTAL_CODE);
        dar.put(DarConstants.COUNTRY, COUNTRY);
        dar.put(DarConstants.STATE, STATE);
        dar.put(DarConstants.STREET_ADDRESS_2, STREET_2);
        dar.put(DarConstants.DIVISION, DIVISION);
        ...
        dar.put(ResearcherFields.ARE_YOU_PRINCIPAL_INVESTIGATOR.getValue(), "true");
