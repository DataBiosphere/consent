...
insert into consents(consentId, requiresManualReview,useRestriction,active,name,createDate,lastUpdate,sortDate,dataUse,dataUseLetter,dulName,groupName) values ('testId3',true,'{"type":"everything"}',true,'testName3',now(),now(),now(),'','dataUseLetter-link-03.here','dulName-03.pdf', "Test Group Name");
