...
public abstract class AbstractEmailNotifierAPI implements EmailNotifierAPI {
     ...
     * to call setInstance().
     */
    protected static class EmailNotifierAPIHolder {
        private static EmailNotifierAPI theInstance = null;
         ...
         */
        public static void setInstance(EmailNotifierAPI api) {
            if (theInstance != null)
         ...
         */
        public static EmailNotifierAPI getInstance() {
            if (theInstance == null)
                throw new IllegalStateException();
            return theInstance;
        }
     ...
     */
    public static EmailNotifierAPI getInstance() {
        return EmailNotifierAPIHolder.getInstance();
    }
     ...
     */
    public static void clearInstance() {
        EmailNotifierAPIHolder.clearInstance();
    }
}
