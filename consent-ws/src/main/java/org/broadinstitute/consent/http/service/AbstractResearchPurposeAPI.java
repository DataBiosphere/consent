...
/**
 * Implement a skeleton for ResearchPurposeAPI interface that implements the singleton
 * object management.
 */
public abstract class AbstractResearchPurposeAPI implements ResearchPurposeAPI {
     ...
     * to call setInstance().
     */
    protected static class ResearchPurposeAPIHolder {
        private static ResearchPurposeAPI theInstance = null;
         ...
         */
        public static void setInstance(ResearchPurposeAPI api) {
            if (theInstance != null)
         ...
         */
        public static ResearchPurposeAPI getInstance() {
            if (theInstance == null)
                throw new IllegalStateException();
            return theInstance;
        }
     ...
     */
    public static ResearchPurposeAPI getInstance() {
        return ResearchPurposeAPIHolder.getInstance();
    }
     ...
     */
    public static void clearInstance() {
        ResearchPurposeAPIHolder.clearInstance();
    }
