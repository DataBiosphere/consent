...
public abstract class AbstractHelpReportAPI implements HelpReportAPI {
    // Implement singleton management for the HelpReportAPI.  We need to explicitly implement a singleton pattern,
     ...
     */
    protected static class HelpReportAPIHolder {
        private static HelpReportAPI theInstance = null;
         ...
         */
        public static void setInstance(HelpReportAPI api) {
            if (theInstance != null)
         ...
         */
        public static HelpReportAPI getInstance() {
            if (theInstance == null)
                throw new IllegalStateException();
            return theInstance;
        }
     ...
     */
    public static HelpReportAPI getInstance() {
        return HelpReportAPIHolder.getInstance();
    }
     ...
     */
    public static void clearInstance() {
        HelpReportAPIHolder.clearInstance();
    }
