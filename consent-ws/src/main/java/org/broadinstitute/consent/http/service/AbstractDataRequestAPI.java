 ...
 * object management.
 */
public abstract class AbstractDataRequestAPI implements DataRequestAPI {
     ...
     * to call setInstance().
     */
    protected static class DataRequestAPIHolder {
        private static DataRequestAPI theInstance = null;
         ...
         */
        public static void setInstance(DataRequestAPI api) {
            if (theInstance != null)
         ...
         */
        public static DataRequestAPI getInstance() {
            if (theInstance == null)
                throw new IllegalStateException();
            return theInstance;
        }
     ...
     */
    public static DataRequestAPI getInstance() {
        return DataRequestAPIHolder.getInstance();
    }
     ...
     */
    public static void clearInstance() {
        DataRequestAPIHolder.clearInstance();
    }
