...
public class ConsentResource extends Resource {
    ...
    public Response createConsent(@Context UriInfo info, Consent rec) {
        try {
            rec.setTranslatedUseRestriction(translateServiceAPI.translateAsHtml(TranslateType.SAMPLESET.getValue(),rec.getUseRestriction()));
    ...
    public Response update(@PathParam("id") String id, Consent updated) {
        try {
            updated.setTranslatedUseRestriction(translateServiceAPI.translateAsHtml(TranslateType.SAMPLESET.getValue(),updated.getUseRestriction()));
