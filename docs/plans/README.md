...
| `vodar-plan.md` | Plan for VODAR (View Only Data Access Requests) across duos-ui and consent: a constrained, RADAR auto-approved DAR for viewing data without analysis or publication. |
