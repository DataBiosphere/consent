            ...
            $stateProvider
                ...
                // route to show our basic form (/form)
                    .state('dul_review', {
                        name: 'dul_review',
                        url: '/dul_review',
                        templateUrl: 'review/dul_review.html',
                ...
                // route to show our basic form (/form)
                    .state('dul_review_results', {
                        ...
                        templateUrl: 'review_results/dul_review_results.html',
                        controller: 'review_resultsCtrl',
                ...
                // route to show our basic form (/form)
                    .state('access_review', {
                        name: 'access_review',
                        url: '/access_review',
                        templateUrl: 'review/access_review.html',
                        controller: 'reviewCtrl',
                        controllerAs: 'Review'
                    })
                // route to show our basic form (/form)
                    .state('access_review_results', {
                        ...
                        templateUrl: 'review_results/access_review_results.html',
                        controller: 'review_resultsCtrl',
                        controllerAs: 'ReviewResults'
                    })
                // route to show our basic form (/form)
